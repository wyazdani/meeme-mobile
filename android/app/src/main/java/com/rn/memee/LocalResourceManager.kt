...
import com.rn.memee.IMAGE_SELECTION
import com.rn.memee.IMAGE_VIDEO_ORDER_BY
import com.rn.memee.IMAGE_VIDEO_PROJECTION
import com.rn.memee.IMAGE_VIDEO_SELECTION
import com.rn.memee.IMAGE_VIDEO_URI
import com.rn.memee.Img
import com.rn.memee.Mode
import com.rn.memee.ModelList
import com.rn.memee.TAG
import com.rn.memee.VIDEO_SELECTION
...
internal class LocalResourceManager(
    ...
    fun retrieveMedia(
        ...
        val cursor = context.getImageVideoCursor(Mode.Picture)
