                ...
                return (<>
                    <View style={{marginHorizontal: wp(5)}}>
                        ...
                        <TouchableOpacity
                            ...
                            disabled={isLoading}
                            style={{alignSelf: 'flex-end', marginTop: hp(0.5)}}
                        >
                            <Text style={{...styles.forgotStyle, color: '#FFCD2F'}}>
                                Forgot Password?
                            </Text>
                        </TouchableOpacity>
                    </View>
...
const styles = {
    ...
    warningStyle: {
        fontSize: wp(2.8), marginBottom: hp(1),
    },
    ...
    forgotStyle: {alignSelf: 'flex-end', marginTop: hp(1), fontSize: wp(4)},
};
