...
//  const { VoiceChangingModule ,MyCustomModule} = NativeModules;
...
const BottomTabScreen =React.memo( () => {
    ...
    const { MemeeModule } = NativeModules;
    console.log("MemeeModule>>>>>>>",MemeeModule);

    const font = fonts(fontChange);
    const [mediaSelect, setMediaSelect] = useState(false);
    const [iosScreen, setIOSScreen] = useState(false);
    ...
    const openNativeScreen = () => {
        ...
        console.log("called androd");
        // const data = {
        //   key1: 'value1',
        //   key2: 'value2',
        // };
        MemeeModule.goToNextScreen();
      };
    const Test = () => {
        return null;
    };
    ...
    return (<>
      ...
      <CustomNativeScreen style={styles.nativeScreen} />
    </View>:null} */}
        <MediaSelectionPopup
